...
execute_process(
  COMMAND "/usr/bin/git" show-ref "389cb68b87193358358ae87cc56d257fd0d80189"
  WORKING_DIRECTORY "/home/xubuntu/src/CPlusPlus20ForProgrammers-master/examples/libraries/GSL/tests/googletest-src"
...
if(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/remotes/")
  ...
  set(checkout_name "389cb68b87193358358ae87cc56d257fd0d80189")
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("389cb68b87193358358ae87cc56d257fd0d80189" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(fetch_required YES)
  set(checkout_name "origin/389cb68b87193358358ae87cc56d257fd0d80189")
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/xubuntu/src/CPlusPlus20ForProgrammers-master/examples/libraries/GSL/tests/googletest-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/xubuntu/src/CPlusPlus20ForProgrammers-master/examples/libraries/GSL/tests/googletest-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
